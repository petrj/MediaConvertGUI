...
public partial class MainWindow
{
	...
	protected virtual void Build ()
	{
		...
		w23.LabelProp = global::Mono.Unix.Catalog.GetString ("Apply");
		w23.UseUnderline = true;
		w20.Add (w23);
		w19.Add (w20);
		this.buttonApply.Add (w19);
		this.@fixed.Add (this.buttonApply);
		global::Gtk.Fixed.FixedChild w27 = ((global::Gtk.Fixed.FixedChild)(this.@fixed [this.buttonApply]));
		w27.X = 5;
		w27.Y = 535;
		// Container child fixed.Gtk.Fixed+FixedChild
		...
		global::Gtk.Fixed.FixedChild w30 = ((global::Gtk.Fixed.FixedChild)(this.@fixed [this.frameGeneral]));
		w30.X = 5;
		w30.Y = 390;
		this.Add (this.@fixed);
		if ((this.Child != null)) {
